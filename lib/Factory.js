...
Factory.prototype.create_from_json = function(json) {
    ...
    return new Structure({
        ...
        'globalStates': new GlobalStates({
            ...
            'favColorSequences': new UUID(json.globalStates.favColorSequences),
            'favColors': new UUID(json.globalStates.favColors),
            'miniserverTime': new UUID(json.globalStates.miniserverTime),
            'liveSearch': new UUID(json.globalStates.liveSearch),
            'userSettings': new UUID(json.globalStates.userSettings),
            'userSettingsTs': new UUID(json.globalStates.userSettingsTs),
            'cloudservice': new UUID(json.globalStates.cloudservice),
            'hasInternet': new UUID(json.globalStates.hasInternet)
        }),
        'operatingModes': json.operatingModes,
